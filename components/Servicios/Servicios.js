...
const servicios = [
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M18 8h1a4 4 0 010 8h-1M2 8h16v9a4 4 0 01-4 4H6a4 4 0 01-4-4V8zM6 1v3M10 1v3M14 1v3" stroke="#6D44FB" strokeWidth="1.75" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <rect x="3" y="3" width="18" height="18" rx="3" stroke="#6D44FB" strokeWidth="1.75" />
        <path d="M8 12h8M8 8h8M8 16h4" stroke="#6D44FB" strokeWidth="1.75" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M2 20h20M6 20V10l6-8 6 8v10" stroke="#6D44FB" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M10 20v-5h4v5" stroke="#6D44FB" strokeWidth="1.75" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <path d="M12 7v5l3 3" stroke="#6D44FB" strokeWidth="1.75" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" stroke="#6D44FB" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" stroke="#6D44FB" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
];
    ...
    <section id="servicios" className={styles.section}>
      <div className={styles.header}>
        ...
        <p className={`${styles.intro} reveal reveal-delay-2`}>
          Soluciones creativas y estratégicas diseñadas para llevar tu marca al siguiente nivel.
        </p>
      </div>
      <div className={styles.grid}>
        {servicios.map((s, i) => (
          <div key={i} className={`${styles.card} servicio-card reveal reveal-delay-${(i % 3) + 1}`}>
